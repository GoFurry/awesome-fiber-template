...
func Create(user *models.User) common.Error {
	engine, err := engine()
	if err != nil {
		return err
	}
...
func GetByID(id int64) (*models.User, common.Error) {
	engine, err := engine()
	if err != nil {
		return nil, err
	}
...
func Update(user *models.User) common.Error {
	engine, err := engine()
	if err != nil {
		return err
	}
...
func Delete(id int64) common.Error {
	engine, err := engine()
	if err != nil {
		return err
	}
...
func List(filter UserListFilter) ([]models.User, int64, common.Error) {
	engine, err := engine()
	if err != nil {
		return nil, 0, err
	}
