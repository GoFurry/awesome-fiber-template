...
import (
	...
	"github.com/GoFurry/awesome-go-template/fiber/v3/heavy/internal/bootstrap"
...
func newMigrateCmd() *cobra.Command {
	migrateCmd := &cobra.Command{
		Use:   "migrate",
		Short: "Run registered database migrations",
	}

	migrateCmd.AddCommand(&cobra.Command{
		Use:   "up",
		Short: "Apply registered database migrations",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			return initConfig()
		},
		RunE: func(cmd *cobra.Command, args []string) error {
			return bootstrap.RunMigrations()
		},
	})
