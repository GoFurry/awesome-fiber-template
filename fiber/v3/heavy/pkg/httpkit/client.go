...
func ConfigureDefault(options *RequestOptions) {
	DefaultClient = NewHTTPClient(options)
}
...
func SetDefaultTimeout(timeout time.Duration) {
	...
	options := DefaultClient.defaultOptions()
