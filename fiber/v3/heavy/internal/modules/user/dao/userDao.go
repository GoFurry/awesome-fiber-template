...
func (repo *UserRepository) Create(user *models.User) common.Error {
	engine, err := repo.engine()
	if err != nil {
		return err
	}
...
func (repo *UserRepository) GetByID(id int64) (*models.User, common.Error) {
	engine, err := repo.engine()
	if err != nil {
		return nil, err
	}
...
func (repo *UserRepository) Update(user *models.User) common.Error {
	engine, err := repo.engine()
	if err != nil {
		return err
	}
...
func (repo *UserRepository) Delete(id int64) common.Error {
	engine, err := repo.engine()
	if err != nil {
		return err
	}
...
func (repo *UserRepository) List(filter UserListFilter) ([]models.User, int64, common.Error) {
	engine, err := repo.engine()
	if err != nil {
		return nil, 0, err
	}
...
func (repo *UserRepository) engine() (*gorm.DB, common.Error) {
	engine := db.Orm.DB()
	if engine == nil {
