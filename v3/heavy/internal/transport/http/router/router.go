...
import (
	...
	"github.com/GoFurry/awesome-fiber-template/v3/heavy/internal/bootstrap"
	applog "github.com/GoFurry/awesome-fiber-template/v3/heavy/internal/infra/logging"
	"github.com/GoFurry/awesome-fiber-template/v3/heavy/internal/transport/http/middleware"
	"github.com/GoFurry/awesome-fiber-template/v3/heavy/internal/transport/http/webui"
...
func registerMiddlewares(app *fiber.App) {
	...
	if cfg.Prometheus.Enabled {
		prometheusMiddleware := middleware.NewPrometheus(middleware.FiberPromConf{
			Namespace:         cfg.Prometheus.Namespace,
			SkipPaths:         []string{cfg.Prometheus.Path},
			IgnoreStatusCodes: []int{},
		})
		app.Use(prometheusMiddleware.Handler)
		app.Get(cfg.Prometheus.Path, prometheusMiddleware.MetricsHandler())
	}
}
